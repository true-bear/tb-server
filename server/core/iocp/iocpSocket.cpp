...
bool IocpSocket::GetPeerName(sockaddr_in& addr) const {
...
bool IocpSocket::GetSocketInfo(WSAPROTOCOL_INFO& info) const {
...
bool IocpSocket::SetOption(int level, int optname, const void* optval, int optlen) {
